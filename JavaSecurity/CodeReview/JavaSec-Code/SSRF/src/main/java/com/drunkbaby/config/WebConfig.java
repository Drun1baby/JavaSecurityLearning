...
public class WebConfig {
     ...
     */
    @Value("${drunkbaby.security.jsonp.referer.check.enabled}")
    ...
    @Value("${drunkbaby.security.jsonp.callback}")
    ...
    @Value("${drunkbaby.security.referer.enabled}")
    ...
    @Value("${drunkbaby.security.referer.host}")
    ...
    @Value("${drunkbaby.security.referer.uri}")
    ...
    @Value("${drunkbaby.business.callback}")
