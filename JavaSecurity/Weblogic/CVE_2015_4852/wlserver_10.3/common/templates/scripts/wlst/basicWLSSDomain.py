...
addTemplate("E:/Coding/JavaSec/wlserver_10.3/common/templates/domains/sipserverdomain.jar")
...
writeDomain('E:/Coding/JavaSec/user_projects/domains/basicWLSSDomain')
closeTemplate()
