...
addTemplate("E:/Coding/JavaSec/wlserver_10.3/common/templates/domains/replicateddomain.jar")
...
writeDomain('E:/Coding/JavaSec/user_projects/domains/replicatedDomain')
closeTemplate()
